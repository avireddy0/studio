...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 space-y-6 bg-[#0A0A0F] min-h-screen relative overflow-hidden">
      {/* HUD OVERLAY */}
      <div className="absolute inset-0 tactical-grid pointer-events-none opacity-[0.03]" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 relative z-10">
        {[
          ...
          <Card key={i} className="bg-[#12121A] border-[#1E1E2E] rounded-none shadow-none hover:border-primary/40 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
        ...
        {/* INTEL TERMINAL (CHAT) - CORE ORCHESTRATION */}
        <Card className="lg:col-span-2 bg-[#12121A] border-[#1E1E2E] rounded-none min-h-[500px] flex flex-col shadow-none">
        ...
        {/* RISK MATRIX & GEOSPATIAL */}
        <div className="space-y-6 flex flex-col">
            <Card className="bg-[#12121A] border-[#1E1E2E] rounded-none shadow-none">
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between group">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[8px] font-mono text-muted-foreground uppercase">Threat: {site.risk}</span>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="h-1 w-20 bg-secondary overflow-hidden">
            ...
            <Card className="bg-[#12121A] border-[#1E1E2E] rounded-none shadow-none flex-1">
                <CardHeader className="border-b border-[#1E1E2E]/50 py-3">
                    <CardTitle className="text-[10px] tracking-[0.3em]">GEOSPATIAL_STATUS</CardTitle>
                </CardHeader>
                <CardContent className="p-6 flex flex-col items-center justify-center text-center gap-4 min-h-[200px]">
                    <div className="relative">
                        <MapIcon className="size-10 text-primary/10" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 relative z-10">
        ...
        <Card className="bg-[#12121A] border-[#1E1E2E] rounded-none flex flex-col shadow-none">
          <CardHeader className="border-b border-[#1E1E2E]/50 bg-[#0A0A0F]/50 py-3">
            <div className="flex items-center justify-between">
                <div className="flex flex-col gap-1">
                    ...
                    <CardDescription className="text-[8px] font-mono text-primary/60 uppercase tracking-widest">From Chaos to Control</CardDescription>
                </div>
                <span className="text-[8px] font-mono text-muted-foreground uppercase">Buffer: 99.8%</span>
            </div>
          </CardHeader>
          <CardContent className="p-6">
          ...
          <CardHeader className="border-b border-[#1E1E2E]/50 bg-[#0A0A0F]/50 py-3">
            <div className="flex items-center justify-between">
                <div className="flex flex-col gap-1">
                    ...
                    <CardDescription className="text-[8px] font-mono text-primary/60 uppercase tracking-widest">Context is Everything</CardDescription>
                </div>
