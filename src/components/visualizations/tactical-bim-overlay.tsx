...
export function TacticalBimOverlay() {
  ...
  return (
    <div className="relative w-full h-[60vh] lg:h-full overflow-hidden border border-primary/20 bg-black">
      ...
      {/* HUD ELEMENTS */}
      <div className="absolute inset-0 p-3 sm:p-5 md:p-8 flex flex-col justify-between z-20">
        <div className="flex justify-between items-start">
          <div className="space-y-4">
            <div className="flex items-center gap-3 bg-black/80 border border-primary/40 px-2 py-1.5 sm:px-4 sm:py-2">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] md:text-[8px] font-mono text-primary uppercase">Precision: 0.02mm Delta</span>
              </div>
            </div>
            <div className="hidden sm:block bg-black/80 border border-white/10 px-4 py-3 space-y-2">
          ...
          <div className="hidden sm:flex bg-primary/5 border border-primary/20 backdrop-blur-md p-4 flex-col items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-4 md:gap-6">
          <div className="bg-black/80 border-l-2 border-primary p-2 sm:p-3 md:p-4 space-y-1">
            <p className="text-[10px] md:text-[8px] text-muted-foreground uppercase tracking-widest">Progress_Metric</p>
            <div className="flex items-baseline gap-2">
              <span className="text-lg sm:text-xl md:text-2xl font-mono font-bold text-white">74.2%</span>
              <span className="text-[9px] text-primary uppercase font-bold">+1.2% Δ</span>
            </div>
          </div>
          <div className="bg-black/80 border-l-2 border-yellow-500 p-2 sm:p-3 md:p-4 space-y-1">
            <p className="text-[10px] md:text-[8px] text-muted-foreground uppercase tracking-widest">Accuracy_Variance</p>
            <div className="flex items-baseline gap-2">
              <span className="text-lg sm:text-xl md:text-2xl font-mono font-bold text-white">99.85%</span>
              <span className="text-[9px] text-yellow-500 uppercase font-bold">In_Spec</span>
            </div>
          </div>
          <div className="bg-black/80 border-l-2 border-primary p-2 sm:p-3 md:p-4 space-y-1">
            <p className="text-[10px] md:text-[8px] text-muted-foreground uppercase tracking-widest">Budget_Efficiency</p>
            <div className="flex items-baseline gap-2">
              <span className="text-lg sm:text-xl md:text-2xl font-mono font-bold text-white">1.04</span>
